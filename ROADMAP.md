...
Formerly on this list: **automated Bucket D routing in triage** was deferred in [ADR-0019](adr/0019-bucket-d-analysis-and-pipeline.md), then built - triage now routes A, C, and D, and the router's accuracy is measured by the scored spot-check ([ADR-0024](adr/0024-triage-accuracy-eval.md)).
